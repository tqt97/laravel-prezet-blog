    ...
    <x-prezet.alpine>
        <div class="grid grid-cols-12 gap-8">
                ...
                <ul class="flex flex-wrap items-center gap-3 font-medium">
                    <li class="w-full sm:w-auto dark:text-white">
                        <a href="#author" class="group flex items-center gap-x-2">
                            <img src="{{ $author['image'] }}" alt="{{ $author['name'] }} profile image" width="26"
            ...
            <div class="-mx-8 sm:mx-0 col-span-12 xl:col-start-2 xl:col-span-10 lg:my-4">
                <img src="/prezet/img/bobs.webp" alt="bob" width="1120" height="595" loading="lazy" decoding="async"
            ...
            {{-- Main Content --}}
            <div class="col-span-12 lg:col-span-9 xl:col-span-8 xl:col-start-2 2xl:col-span-6 2xl:col-start-4">
